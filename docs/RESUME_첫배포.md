...
**OBS 녹화 무음 문제는 해결됐다.** 최종 시험에서 확인한 것:

- 마이크(K66) 입력 정상
- OBS 녹음 정상
- **재생 정상** ← 여기까지 확인해야 확인이다

**막힌 것이 없다. 1강 촬영을 바로 시작할 수 있다.**

> 무음일 때 뒤지는 순서는 `docs/course/recording-checklist.md` 6번 아래에
> 남겨 뒀다. 마이크를 바꾸거나 윈도우가 업데이트되면 또 생길 수 있다.

### 지금 바로 할 수 있는 것

| 순서 | 무엇 | 대본 | 걸리는 시간 |
|---|---|---|---|
| 1 | **1강 촬영** | ✅ 확정 | 약 2시간 25분 |
| 2 | 2강 촬영 | ✅ 확정 | 약 3시간 30분 (+ 촬영 방법 결정 30분) |
| 3 | 3강 촬영 | 🟡 초안 | 약 2시간 35분 |

**1강부터 찍는다.** 무료 공개분이고, 화면이 다 준비돼 있고, 8분으로 가장 짧다.
순서와 이유는 `docs/course/filming-map.md`에 있다.

**아직 사장님이 정할 것 하나** — 2강 촬영 방법 (새 Windows 계정을 만들지).
1강을 찍는 동안 생각하시면 된다. 1강에는 영향이 없다.
